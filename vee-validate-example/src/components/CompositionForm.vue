<template>
    <form class="form" @submit.prevent="onSubmit">
        <h1 class="form-header">Vee Validate Composition</h1>
        ...
        <div class="form-control">
            ...
            <input v-model="password" :type="show ? 'text' : 'password'" id="password" class="input"/>
...
const [email, emailMeta] = defineField('email', { type: 'email', required: true })
const [password, passwordMeta] = defineField('password', { type: 'password', required: true })
